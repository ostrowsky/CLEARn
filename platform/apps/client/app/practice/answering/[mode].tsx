...
const styles = StyleSheet.create({
  ...
  userBubble: { alignSelf: 'flex-end', backgroundColor: tokens.colors.accentSoft },
  coachBubble: { alignSelf: 'flex-start', backgroundColor: tokens.colors.backgroundDeep },
  ...
  button: { backgroundColor: tokens.colors.accent, borderRadius: tokens.radius.pill, paddingVertical: tokens.spacing.md, paddingHorizontal: tokens.spacing.lg, alignItems: 'center', justifyContent: 'center' },
  buttonText: { color: '#fff', fontWeight: '800', textAlign: 'center' },
  secondaryButton: { backgroundColor: tokens.colors.surfaceMuted, borderRadius: tokens.radius.pill, paddingVertical: tokens.spacing.md, paddingHorizontal: tokens.spacing.lg, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: tokens.colors.cardLine },
  secondaryText: { color: tokens.colors.accentDeep, fontWeight: '800', textAlign: 'center' },
  buttonDisabled: { opacity: 0.55 },
  feedbackCard: { borderRadius: tokens.radius.md, padding: tokens.spacing.md, backgroundColor: tokens.colors.backgroundDeep, borderWidth: 1, borderColor: tokens.colors.line },
  ...
  reactionCategoryButton: { paddingHorizontal: 16, paddingVertical: 12, borderRadius: tokens.radius.pill, backgroundColor: tokens.colors.surfaceMuted, borderWidth: 1, borderColor: tokens.colors.cardLine, gap: 6 },
  reactionCategoryButtonActive: { borderColor: tokens.colors.accent, backgroundColor: tokens.colors.accentSoft },
  ...
  reactionDropdown: { gap: tokens.spacing.xs, padding: tokens.spacing.sm, borderRadius: tokens.radius.md, backgroundColor: tokens.colors.backgroundDeep, borderWidth: 1, borderColor: tokens.colors.cardLine },
  ...
  choiceChipActive: { borderColor: tokens.colors.accent, backgroundColor: tokens.colors.accentSoft },
  choiceText: { color: tokens.colors.inkSoft, fontWeight: '700' },
  choiceTextActive: { color: tokens.colors.accentDeep },
  noticeCard: { borderRadius: tokens.radius.md, padding: tokens.spacing.md, backgroundColor: tokens.colors.backgroundDeep, borderWidth: 1, borderColor: tokens.colors.cardLine },
