...
const schema = z.object({
  ...
  POSTGRES_URL: z.string().default('postgres://clearn:clearn@localhost:5432/clearn'),
  REDIS_URL: z.string().default('redis://localhost:6379'),
  S3_ENDPOINT: z.string().default('http://localhost:9000'),
  S3_REGION: z.string().default('us-east-1'),
  S3_BUCKET: z.string().default('clearn-media'),
  ...
  SELF_HOSTED_STT_MODEL: z.string().default('base.en'),
