...
$tests = @(
    (Join-Path $PSScriptRoot 'Service.Tests.ps1'),
    ...
    (Join-Path $PSScriptRoot 'PlatformPracticeFallback.Tests.ps1'),
    (Join-Path $PSScriptRoot 'PlatformPractice.ApiSmoke.Tests.ps1'),
    (Join-Path $PSScriptRoot 'PlatformVisualRegression.Tests.ps1'),
    (Join-Path $PSScriptRoot 'PlatformQuestionFormation.Tests.ps1'),
    (Join-Path $PSScriptRoot 'PlatformQuestionFormation.Api.Tests.ps1'),
    (Join-Path $PSScriptRoot 'PlatformInputValidation.Tests.ps1'),
    (Join-Path $PSScriptRoot 'PlatformInputValidation.Api.Tests.ps1'),
    ...
    (Join-Path $PSScriptRoot 'PlatformDesign.Tests.ps1'),
